...
function ProductDetails() {
     const [previewImg,setPreviewImg] = useState(main_img)
          ...
          <Col className="p-3 " md={6} lg={6} sm={12} xs={12}>
               <Row className="p-2">
                    <Col md={2} lg={2} sm={12} xs={12} >
                         ...
                         <img className="smallimage product-sm-img"  src={one_img} alt='' onClick={imgOnClick}/>
                         </Col>
                         <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                         <img className="smallimage product-sm-img"  src={two_img} alt='' onClick={imgOnClick}/>
                         </Col>
                         <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                         <img className="smallimage product-sm-img"  src={three_img} alt='' onClick={imgOnClick}/>
                         </Col>
                         <Col className="p-0 m-0" md={12} lg={12} sm={3} xs={3}>
                         <img className="smallimage product-sm-img"  src={four_img} alt='' onClick={imgOnClick}/>
                         </Col>
                    </Col>
